...
export class Route2Component implements OnInit {
  isGridViewSelected: boolean = true;
  vegetables = [
    {
      id: 101,
      tname: 'Pepperoni',
    ...
    {
      id: 128,
      tname: 'Baby corn unpeeled 500 g',
      price: 45,
      image:
        'https://thumb7.shutterstock.com/display_pic_with_logo/259963/259963,1235208469,1/stock-photo-vegetables-bulgarian-pepper-on-a-white-background-isolated-25335661.jpg',
    },
    ...
    {
      id: 130,
      tname: 'Cucumber Mangalore 1 Units',
      price: 15,
      image:
        'https://thumb7.shutterstock.com/display_pic_with_logo/259963/259963,1235208469,1/stock-photo-vegetables-bulgarian-pepper-on-a-white-background-isolated-25335661.jpg',
    },
  ...
  ngOnInit(): void {
    this.vegetablesList = this.vegetables;
  }
  filterResult(e: any) {
    switch (e.target.value) {
      case 'L2H':
        this.vegetablesList = this.vegetables.sort((a, b) => a.price - b.price);
        break;
      case 'H2L':
        this.vegetablesList = this.vegetables.sort((a, b) => b.price - a.price);
        break;
      default:
        this.vegetablesList = this.vegetables;
    }
